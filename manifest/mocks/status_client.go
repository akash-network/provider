...
func (_m *StatusClient) Status(_a0 context.Context) (*rest.ManifestStatus, error) {
	ret := _m.Called(_a0)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*rest.ManifestStatus, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *rest.ManifestStatus); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_c *StatusClient_Status_Call) Return(_a0 *rest.ManifestStatus, _a1 error) *StatusClient_Status_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StatusClient_Status_Call) RunAndReturn(run func(context.Context) (*rest.ManifestStatus, error)) *StatusClient_Status_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *StatusClient) StatusV1(_a0 context.Context) (*v1.ManifestStatus, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*v1.ManifestStatus, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *v1.ManifestStatus); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_e *StatusClient_Expecter) StatusV1(_a0 interface{}) *StatusClient_StatusV1_Call {
	return &StatusClient_StatusV1_Call{Call: _e.mock.On("StatusV1", _a0)}
}

func (_c *StatusClient_StatusV1_Call) Run(run func(_a0 context.Context)) *StatusClient_StatusV1_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *StatusClient_StatusV1_Call) Return(_a0 *v1.ManifestStatus, _a1 error) *StatusClient_StatusV1_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StatusClient_StatusV1_Call) RunAndReturn(run func(context.Context) (*v1.ManifestStatus, error)) *StatusClient_StatusV1_Call {
	_c.Call.Return(run)
	return _c
}
