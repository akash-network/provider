...
func (_m *StatusClient) Status(_a0 context.Context) (*manifest.Status, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*manifest.Status, error)); ok {
		return rf(_a0)
	}
...
func (_c *StatusClient_Status_Call) Return(_a0 *manifest.Status, _a1 error) *StatusClient_Status_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StatusClient_Status_Call) RunAndReturn(run func(context.Context) (*manifest.Status, error)) *StatusClient_Status_Call {
	_c.Call.Return(run)
	return _c
}
