...
func TestParseSidecarAttestationQuoteResponsePreservesLegacyGPUReport(t *testing.T) {
	data := []byte(`{"report":"Y3B1","tee_platform":"snp-gpu","gpu_reports":[{"device_index":3,"report":"bGVnYWN5"}]}`)
...
func TestParseSidecarAttestationQuoteResponseRejectsInvalidEvidence(t *testing.T) {
	tests := []struct {
		...
		{name: "empty legacy report", data: `{"report":"Y3B1","tee_platform":"snp-gpu","gpu_reports":[{"device_index":1}]}`, wantErr: "legacy GPU report is empty"},
		{name: "explicit fields without legacy report", data: `{"report":"Y3B1","tee_platform":"snp-gpu","gpu_reports":[{"device_index":1,"attestation_report":"cmVwb3J0","certificate_chain":"Y2hhaW4="}]}`, wantErr: "legacy GPU report is empty"},
		{name: "partial explicit report", data: `{"report":"Y3B1","tee_platform":"snp-gpu","gpu_reports":[{"device_index":1,"report":"bGVnYWN5","attestation_report":"cmVwb3J0"}]}`, wantErr: "GPU certificate chain is empty"},
		{name: "invalid CEC report", data: `{"report":"Y3B1","tee_platform":"snp-gpu","gpu_reports":[{"device_index":1,"report":"bGVnYWN5","attestation_report":"cmVwb3J0","cec_report":"***","certificate_chain":"Y2hhaW4="}]}`, wantErr: "GPU CEC report is not valid base64"},
		{name: "legacy report disagrees with explicit fields", data: `{"report":"Y3B1","tee_platform":"snp-gpu","gpu_reports":[{"device_index":1,"report":"bGVnYWN5","attestation_report":"cmVwb3J0","certificate_chain":"Y2hhaW4="}]}`, wantErr: "legacy report does not match explicit evidence fields"},
		{name: "duplicate device", data: `{"report":"Y3B1","tee_platform":"snp-gpu","gpu_reports":[{"device_index":1,"report":"b25l"},{"device_index":1,"report":"dHdv"}]}`, wantErr: "duplicate GPU device index 1"},
	}
