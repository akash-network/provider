...
func (_c *ReplicaSetsGetter_ReplicaSets_Call) Return(_a0 v1beta1.ReplicaSetInterface) *ReplicaSetsGetter_ReplicaSets_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ReplicaSetsGetter_ReplicaSets_Call) RunAndReturn(run func(string) v1beta1.ReplicaSetInterface) *ReplicaSetsGetter_ReplicaSets_Call {
	_c.Call.Return(run)
	return _c
}
