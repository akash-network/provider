...
func (_c *IngressesGetter_Ingresses_Call) Return(_a0 v1beta1.IngressInterface) *IngressesGetter_Ingresses_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *IngressesGetter_Ingresses_Call) RunAndReturn(run func(string) v1beta1.IngressInterface) *IngressesGetter_Ingresses_Call {
	_c.Call.Return(run)
	return _c
}
