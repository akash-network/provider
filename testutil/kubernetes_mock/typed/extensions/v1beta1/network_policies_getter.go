...
func (_c *NetworkPoliciesGetter_NetworkPolicies_Call) Return(_a0 v1beta1.NetworkPolicyInterface) *NetworkPoliciesGetter_NetworkPolicies_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *NetworkPoliciesGetter_NetworkPolicies_Call) RunAndReturn(run func(string) v1beta1.NetworkPolicyInterface) *NetworkPoliciesGetter_NetworkPolicies_Call {
	_c.Call.Return(run)
	return _c
}
