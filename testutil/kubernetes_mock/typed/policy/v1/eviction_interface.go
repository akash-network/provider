...
func (_m *EvictionInterface) Evict(ctx context.Context, eviction *v1.Eviction) error {
...
func (_c *EvictionInterface_Evict_Call) Run(run func(ctx context.Context, eviction *v1.Eviction)) *EvictionInterface_Evict_Call {
...
func (_c *EvictionInterface_Evict_Call) RunAndReturn(run func(context.Context, *v1.Eviction) error) *EvictionInterface_Evict_Call {
	_c.Call.Return(run)
	return _c
}
