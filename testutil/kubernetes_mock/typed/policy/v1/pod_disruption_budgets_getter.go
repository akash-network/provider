...
func (_m *PodDisruptionBudgetsGetter) PodDisruptionBudgets(namespace string) v1.PodDisruptionBudgetInterface {
...
func (_c *PodDisruptionBudgetsGetter_PodDisruptionBudgets_Call) Return(_a0 v1.PodDisruptionBudgetInterface) *PodDisruptionBudgetsGetter_PodDisruptionBudgets_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PodDisruptionBudgetsGetter_PodDisruptionBudgets_Call) RunAndReturn(run func(string) v1.PodDisruptionBudgetInterface) *PodDisruptionBudgetsGetter_PodDisruptionBudgets_Call {
	_c.Call.Return(run)
	return _c
}
