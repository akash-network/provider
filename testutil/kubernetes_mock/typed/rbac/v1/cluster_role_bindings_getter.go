...
func (_c *ClusterRoleBindingsGetter_ClusterRoleBindings_Call) Return(_a0 v1.ClusterRoleBindingInterface) *ClusterRoleBindingsGetter_ClusterRoleBindings_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ClusterRoleBindingsGetter_ClusterRoleBindings_Call) RunAndReturn(run func() v1.ClusterRoleBindingInterface) *ClusterRoleBindingsGetter_ClusterRoleBindings_Call {
	_c.Call.Return(run)
	return _c
}
