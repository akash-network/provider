...
func (_c *RoleBindingsGetter_RoleBindings_Call) Return(_a0 v1.RoleBindingInterface) *RoleBindingsGetter_RoleBindings_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RoleBindingsGetter_RoleBindings_Call) RunAndReturn(run func(string) v1.RoleBindingInterface) *RoleBindingsGetter_RoleBindings_Call {
	_c.Call.Return(run)
	return _c
}
