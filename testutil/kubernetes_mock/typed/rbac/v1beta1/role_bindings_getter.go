...
func (_m *RoleBindingsGetter) RoleBindings(namespace string) v1beta1.RoleBindingInterface {
...
func (_c *RoleBindingsGetter_RoleBindings_Call) Return(_a0 v1beta1.RoleBindingInterface) *RoleBindingsGetter_RoleBindings_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RoleBindingsGetter_RoleBindings_Call) RunAndReturn(run func(string) v1beta1.RoleBindingInterface) *RoleBindingsGetter_RoleBindings_Call {
	_c.Call.Return(run)
	return _c
}
