...
func (_c *RolesGetter_Roles_Call) Return(_a0 v1alpha1.RoleInterface) *RolesGetter_Roles_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RolesGetter_Roles_Call) RunAndReturn(run func(string) v1alpha1.RoleInterface) *RolesGetter_Roles_Call {
	_c.Call.Return(run)
	return _c
}
