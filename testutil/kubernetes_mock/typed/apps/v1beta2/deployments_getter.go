...
func (_c *DeploymentsGetter_Deployments_Call) Return(_a0 v1beta2.DeploymentInterface) *DeploymentsGetter_Deployments_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *DeploymentsGetter_Deployments_Call) RunAndReturn(run func(string) v1beta2.DeploymentInterface) *DeploymentsGetter_Deployments_Call {
	_c.Call.Return(run)
	return _c
}
