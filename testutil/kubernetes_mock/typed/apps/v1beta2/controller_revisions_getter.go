...
func (_c *ControllerRevisionsGetter_ControllerRevisions_Call) Return(_a0 v1beta2.ControllerRevisionInterface) *ControllerRevisionsGetter_ControllerRevisions_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ControllerRevisionsGetter_ControllerRevisions_Call) RunAndReturn(run func(string) v1beta2.ControllerRevisionInterface) *ControllerRevisionsGetter_ControllerRevisions_Call {
	_c.Call.Return(run)
	return _c
}
