...
func (_c *StatefulSetsGetter_StatefulSets_Call) Return(_a0 v1.StatefulSetInterface) *StatefulSetsGetter_StatefulSets_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *StatefulSetsGetter_StatefulSets_Call) RunAndReturn(run func(string) v1.StatefulSetInterface) *StatefulSetsGetter_StatefulSets_Call {
	_c.Call.Return(run)
	return _c
}
