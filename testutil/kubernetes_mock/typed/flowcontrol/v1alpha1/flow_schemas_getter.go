...
func (_c *FlowSchemasGetter_FlowSchemas_Call) Return(_a0 v1alpha1.FlowSchemaInterface) *FlowSchemasGetter_FlowSchemas_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *FlowSchemasGetter_FlowSchemas_Call) RunAndReturn(run func() v1alpha1.FlowSchemaInterface) *FlowSchemasGetter_FlowSchemas_Call {
	_c.Call.Return(run)
	return _c
}
