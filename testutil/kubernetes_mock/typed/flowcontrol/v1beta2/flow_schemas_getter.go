...
func (_m *FlowSchemasGetter) FlowSchemas() v1beta2.FlowSchemaInterface {
	ret := _m.Called()
...
func (_c *FlowSchemasGetter_FlowSchemas_Call) Return(_a0 v1beta2.FlowSchemaInterface) *FlowSchemasGetter_FlowSchemas_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *FlowSchemasGetter_FlowSchemas_Call) RunAndReturn(run func() v1beta2.FlowSchemaInterface) *FlowSchemasGetter_FlowSchemas_Call {
	_c.Call.Return(run)
	return _c
}
