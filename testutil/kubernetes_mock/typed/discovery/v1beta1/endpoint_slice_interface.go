...
func (_m *EndpointSliceInterface) Apply(ctx context.Context, endpointSlice *v1beta1.EndpointSliceApplyConfiguration, opts v1.ApplyOptions) (*discoveryv1beta1.EndpointSlice, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1beta1.EndpointSliceApplyConfiguration, v1.ApplyOptions) (*discoveryv1beta1.EndpointSlice, error)); ok {
...
//   - ctx context.Context
//   - endpointSlice *v1beta1.EndpointSliceApplyConfiguration
...
func (_c *EndpointSliceInterface_Apply_Call) Run(run func(ctx context.Context, endpointSlice *v1beta1.EndpointSliceApplyConfiguration, opts v1.ApplyOptions)) *EndpointSliceInterface_Apply_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1beta1.EndpointSliceApplyConfiguration), args[2].(v1.ApplyOptions))
	})
	return _c
}

func (_c *EndpointSliceInterface_Apply_Call) Return(result *discoveryv1beta1.EndpointSlice, err error) *EndpointSliceInterface_Apply_Call {
	_c.Call.Return(result, err)
	return _c
}

func (_c *EndpointSliceInterface_Apply_Call) RunAndReturn(run func(context.Context, *v1beta1.EndpointSliceApplyConfiguration, v1.ApplyOptions) (*discoveryv1beta1.EndpointSlice, error)) *EndpointSliceInterface_Apply_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EndpointSliceInterface) Create(ctx context.Context, endpointSlice *discoveryv1beta1.EndpointSlice, opts v1.CreateOptions) (*discoveryv1beta1.EndpointSlice, error) {
	...
	var r0 *discoveryv1beta1.EndpointSlice
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *discoveryv1beta1.EndpointSlice, v1.CreateOptions) (*discoveryv1beta1.EndpointSlice, error)); ok {
		return rf(ctx, endpointSlice, opts)
	}
...
func (_c *EndpointSliceInterface_Create_Call) Run(run func(ctx context.Context, endpointSlice *discoveryv1beta1.EndpointSlice, opts v1.CreateOptions)) *EndpointSliceInterface_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*discoveryv1beta1.EndpointSlice), args[2].(v1.CreateOptions))
	})
	return _c
}

func (_c *EndpointSliceInterface_Create_Call) Return(_a0 *discoveryv1beta1.EndpointSlice, _a1 error) *EndpointSliceInterface_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EndpointSliceInterface_Create_Call) RunAndReturn(run func(context.Context, *discoveryv1beta1.EndpointSlice, v1.CreateOptions) (*discoveryv1beta1.EndpointSlice, error)) *EndpointSliceInterface_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *EndpointSliceInterface_Delete_Call) Run(run func(ctx context.Context, name string, opts v1.DeleteOptions)) *EndpointSliceInterface_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *EndpointSliceInterface_Delete_Call) RunAndReturn(run func(context.Context, string, v1.DeleteOptions) error) *EndpointSliceInterface_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *EndpointSliceInterface_DeleteCollection_Call) Run(run func(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions)) *EndpointSliceInterface_DeleteCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *EndpointSliceInterface_DeleteCollection_Call) RunAndReturn(run func(context.Context, v1.DeleteOptions, v1.ListOptions) error) *EndpointSliceInterface_DeleteCollection_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EndpointSliceInterface) Get(ctx context.Context, name string, opts v1.GetOptions) (*discoveryv1beta1.EndpointSlice, error) {
	...
	var r0 *discoveryv1beta1.EndpointSlice
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, v1.GetOptions) (*discoveryv1beta1.EndpointSlice, error)); ok {
...
func (_c *EndpointSliceInterface_Get_Call) Run(run func(ctx context.Context, name string, opts v1.GetOptions)) *EndpointSliceInterface_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *EndpointSliceInterface_Get_Call) Return(_a0 *discoveryv1beta1.EndpointSlice, _a1 error) *EndpointSliceInterface_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EndpointSliceInterface_Get_Call) RunAndReturn(run func(context.Context, string, v1.GetOptions) (*discoveryv1beta1.EndpointSlice, error)) *EndpointSliceInterface_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EndpointSliceInterface) List(ctx context.Context, opts v1.ListOptions) (*discoveryv1beta1.EndpointSliceList, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, v1.ListOptions) (*discoveryv1beta1.EndpointSliceList, error)); ok {
		return rf(ctx, opts)
	}
...
func (_c *EndpointSliceInterface_List_Call) Run(run func(ctx context.Context, opts v1.ListOptions)) *EndpointSliceInterface_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *EndpointSliceInterface_List_Call) Return(_a0 *discoveryv1beta1.EndpointSliceList, _a1 error) *EndpointSliceInterface_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EndpointSliceInterface_List_Call) RunAndReturn(run func(context.Context, v1.ListOptions) (*discoveryv1beta1.EndpointSliceList, error)) *EndpointSliceInterface_List_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EndpointSliceInterface) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (*discoveryv1beta1.EndpointSlice, error) {
	...
	var r0 *discoveryv1beta1.EndpointSlice
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, types.PatchType, []byte, v1.PatchOptions, ...string) (*discoveryv1beta1.EndpointSlice, error)); ok {
...
func (_c *EndpointSliceInterface_Patch_Call) Run(run func(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string)) *EndpointSliceInterface_Patch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *EndpointSliceInterface_Patch_Call) Return(result *discoveryv1beta1.EndpointSlice, err error) *EndpointSliceInterface_Patch_Call {
	_c.Call.Return(result, err)
	return _c
}

func (_c *EndpointSliceInterface_Patch_Call) RunAndReturn(run func(context.Context, string, types.PatchType, []byte, v1.PatchOptions, ...string) (*discoveryv1beta1.EndpointSlice, error)) *EndpointSliceInterface_Patch_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EndpointSliceInterface) Update(ctx context.Context, endpointSlice *discoveryv1beta1.EndpointSlice, opts v1.UpdateOptions) (*discoveryv1beta1.EndpointSlice, error) {
	...
	var r0 *discoveryv1beta1.EndpointSlice
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *discoveryv1beta1.EndpointSlice, v1.UpdateOptions) (*discoveryv1beta1.EndpointSlice, error)); ok {
		return rf(ctx, endpointSlice, opts)
	}
...
func (_c *EndpointSliceInterface_Update_Call) Run(run func(ctx context.Context, endpointSlice *discoveryv1beta1.EndpointSlice, opts v1.UpdateOptions)) *EndpointSliceInterface_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*discoveryv1beta1.EndpointSlice), args[2].(v1.UpdateOptions))
	})
	return _c
}

func (_c *EndpointSliceInterface_Update_Call) Return(_a0 *discoveryv1beta1.EndpointSlice, _a1 error) *EndpointSliceInterface_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EndpointSliceInterface_Update_Call) RunAndReturn(run func(context.Context, *discoveryv1beta1.EndpointSlice, v1.UpdateOptions) (*discoveryv1beta1.EndpointSlice, error)) *EndpointSliceInterface_Update_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *EndpointSliceInterface_Watch_Call) Run(run func(ctx context.Context, opts v1.ListOptions)) *EndpointSliceInterface_Watch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(v1.ListOptions))
	})
	return _c
...
func (_c *EndpointSliceInterface_Watch_Call) RunAndReturn(run func(context.Context, v1.ListOptions) (watch.Interface, error)) *EndpointSliceInterface_Watch_Call {
	_c.Call.Return(run)
	return _c
}
