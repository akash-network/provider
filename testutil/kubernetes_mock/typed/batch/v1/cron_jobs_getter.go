...
func (_c *CronJobsGetter_CronJobs_Call) Return(_a0 v1.CronJobInterface) *CronJobsGetter_CronJobs_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CronJobsGetter_CronJobs_Call) RunAndReturn(run func(string) v1.CronJobInterface) *CronJobsGetter_CronJobs_Call {
	_c.Call.Return(run)
	return _c
}
