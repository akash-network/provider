...
func (_m *LocalSubjectAccessReviewInterface) Create(ctx context.Context, localSubjectAccessReview *v1.LocalSubjectAccessReview, opts metav1.CreateOptions) (*v1.LocalSubjectAccessReview, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1.LocalSubjectAccessReview, metav1.CreateOptions) (*v1.LocalSubjectAccessReview, error)); ok {
...
//   - ctx context.Context
//   - localSubjectAccessReview *v1.LocalSubjectAccessReview
...
func (_c *LocalSubjectAccessReviewInterface_Create_Call) Run(run func(ctx context.Context, localSubjectAccessReview *v1.LocalSubjectAccessReview, opts metav1.CreateOptions)) *LocalSubjectAccessReviewInterface_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.LocalSubjectAccessReview), args[2].(metav1.CreateOptions))
	})
	return _c
}

func (_c *LocalSubjectAccessReviewInterface_Create_Call) Return(_a0 *v1.LocalSubjectAccessReview, _a1 error) *LocalSubjectAccessReviewInterface_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LocalSubjectAccessReviewInterface_Create_Call) RunAndReturn(run func(context.Context, *v1.LocalSubjectAccessReview, metav1.CreateOptions) (*v1.LocalSubjectAccessReview, error)) *LocalSubjectAccessReviewInterface_Create_Call {
	_c.Call.Return(run)
	return _c
}
