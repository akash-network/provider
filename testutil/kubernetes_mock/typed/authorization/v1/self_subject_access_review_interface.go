...
func (_m *SelfSubjectAccessReviewInterface) Create(ctx context.Context, selfSubjectAccessReview *v1.SelfSubjectAccessReview, opts metav1.CreateOptions) (*v1.SelfSubjectAccessReview, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1.SelfSubjectAccessReview, metav1.CreateOptions) (*v1.SelfSubjectAccessReview, error)); ok {
...
func (_c *SelfSubjectAccessReviewInterface_Create_Call) Run(run func(ctx context.Context, selfSubjectAccessReview *v1.SelfSubjectAccessReview, opts metav1.CreateOptions)) *SelfSubjectAccessReviewInterface_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.SelfSubjectAccessReview), args[2].(metav1.CreateOptions))
	})
	return _c
}

func (_c *SelfSubjectAccessReviewInterface_Create_Call) Return(_a0 *v1.SelfSubjectAccessReview, _a1 error) *SelfSubjectAccessReviewInterface_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SelfSubjectAccessReviewInterface_Create_Call) RunAndReturn(run func(context.Context, *v1.SelfSubjectAccessReview, metav1.CreateOptions) (*v1.SelfSubjectAccessReview, error)) *SelfSubjectAccessReviewInterface_Create_Call {
	_c.Call.Return(run)
	return _c
}
