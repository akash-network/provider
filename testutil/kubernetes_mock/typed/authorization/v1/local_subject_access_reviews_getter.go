...
func (_c *LocalSubjectAccessReviewsGetter_LocalSubjectAccessReviews_Call) Return(_a0 v1.LocalSubjectAccessReviewInterface) *LocalSubjectAccessReviewsGetter_LocalSubjectAccessReviews_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LocalSubjectAccessReviewsGetter_LocalSubjectAccessReviews_Call) RunAndReturn(run func(string) v1.LocalSubjectAccessReviewInterface) *LocalSubjectAccessReviewsGetter_LocalSubjectAccessReviews_Call {
	_c.Call.Return(run)
	return _c
}
