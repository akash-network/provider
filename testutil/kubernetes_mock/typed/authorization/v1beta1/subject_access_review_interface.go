...
func (_m *SubjectAccessReviewInterface) Create(ctx context.Context, subjectAccessReview *v1beta1.SubjectAccessReview, opts v1.CreateOptions) (*v1beta1.SubjectAccessReview, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1beta1.SubjectAccessReview, v1.CreateOptions) (*v1beta1.SubjectAccessReview, error)); ok {
...
func (_c *SubjectAccessReviewInterface_Create_Call) Run(run func(ctx context.Context, subjectAccessReview *v1beta1.SubjectAccessReview, opts v1.CreateOptions)) *SubjectAccessReviewInterface_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1beta1.SubjectAccessReview), args[2].(v1.CreateOptions))
	})
	return _c
}

func (_c *SubjectAccessReviewInterface_Create_Call) Return(_a0 *v1beta1.SubjectAccessReview, _a1 error) *SubjectAccessReviewInterface_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SubjectAccessReviewInterface_Create_Call) RunAndReturn(run func(context.Context, *v1beta1.SubjectAccessReview, v1.CreateOptions) (*v1beta1.SubjectAccessReview, error)) *SubjectAccessReviewInterface_Create_Call {
	_c.Call.Return(run)
	return _c
}
