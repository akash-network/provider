...
func (_m *Client) AttestationQuote(ctx context.Context, lID v1.LeaseID, service string, podIndex uint, requestBody []byte) ([]byte, int, error) {
	ret := _m.Called(ctx, lID, service, podIndex, requestBody)
