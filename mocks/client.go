...
func (_m *Client) Validate(_a0 context.Context, _a1 types.Address, _a2 deploymentv1beta3.GroupSpec) (rest.ValidateGroupSpecResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.Address, deploymentv1beta3.GroupSpec) (rest.ValidateGroupSpecResult, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.Address, deploymentv1beta3.GroupSpec) rest.ValidateGroupSpecResult); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
...
func (_c *Client_Validate_Call) Return(_a0 rest.ValidateGroupSpecResult, _a1 error) *Client_Validate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_Validate_Call) RunAndReturn(run func(context.Context, types.Address, deploymentv1beta3.GroupSpec) (rest.ValidateGroupSpecResult, error)) *Client_Validate_Call {
	_c.Call.Return(run)
	return _c
}
