...
func (_c *Client_Hostname_Call) Return(_a0 v1beta2.HostnameServiceClient) *Client_Hostname_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_Hostname_Call) RunAndReturn(run func() v1beta2.HostnameServiceClient) *Client_Hostname_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Client) Validate(_a0 context.Context, _a1 v1beta3.GroupSpec) (provider.ValidateGroupSpecResult, error) {
	ret := _m.Called(_a0, _a1)

	var r0 provider.ValidateGroupSpecResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, v1beta3.GroupSpec) (provider.ValidateGroupSpecResult, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, v1beta3.GroupSpec) provider.ValidateGroupSpecResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(provider.ValidateGroupSpecResult)
	}

	if rf, ok := ret.Get(1).(func(context.Context, v1beta3.GroupSpec) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Client_Validate_Call) Run(run func(_a0 context.Context, _a1 v1beta3.GroupSpec)) *Client_Validate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(v1beta3.GroupSpec))
	})
	return _c
}
...
func (_c *Client_Validate_Call) RunAndReturn(run func(context.Context, v1beta3.GroupSpec) (provider.ValidateGroupSpecResult, error)) *Client_Validate_Call {
	_c.Call.Return(run)
	return _c
}
