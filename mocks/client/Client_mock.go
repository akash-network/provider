...
// BidScreening provides a mock function for the type Client
func (_mock *Client) BidScreening(context1 context.Context, bidScreeningRequest *v1.BidScreeningRequest) (*v1.BidScreeningResponse, error) {
...
// Client_BidScreening_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BidScreening'
type Client_BidScreening_Call struct {
	*mock.Call
}
...
func (_e *Client_Expecter) BidScreening(context1 interface{}, bidScreeningRequest interface{}) *Client_BidScreening_Call {
	return &Client_BidScreening_Call{Call: _e.mock.On("BidScreening", context1, bidScreeningRequest)}
}

func (_c *Client_BidScreening_Call) Run(run func(context1 context.Context, bidScreeningRequest *v1.BidScreeningRequest)) *Client_BidScreening_Call {
...
func (_c *Client_BidScreening_Call) Return(bidScreeningResponse *v1.BidScreeningResponse, err error) *Client_BidScreening_Call {
	_c.Call.Return(bidScreeningResponse, err)
	return _c
}

func (_c *Client_BidScreening_Call) RunAndReturn(run func(context1 context.Context, bidScreeningRequest *v1.BidScreeningRequest) (*v1.BidScreeningResponse, error)) *Client_BidScreening_Call {
	_c.Call.Return(run)
	return _c
}
