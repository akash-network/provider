...
func (_m *Cluster) Reserve(_a0 v1beta4.OrderID, _a1 v1beta3.ResourceGroup) (typesv1beta3.Reservation, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(v1beta4.OrderID, v1beta3.ResourceGroup) (typesv1beta3.Reservation, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(v1beta4.OrderID, v1beta3.ResourceGroup) typesv1beta3.Reservation); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(v1beta4.OrderID, v1beta3.ResourceGroup) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Cluster_Reserve_Call) Run(run func(_a0 v1beta4.OrderID, _a1 v1beta3.ResourceGroup)) *Cluster_Reserve_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(v1beta4.OrderID), args[1].(v1beta3.ResourceGroup))
	})
	return _c
}
...
func (_c *Cluster_Reserve_Call) RunAndReturn(run func(v1beta4.OrderID, v1beta3.ResourceGroup) (typesv1beta3.Reservation, error)) *Cluster_Reserve_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Cluster_Unreserve_Call) Run(run func(_a0 v1beta4.OrderID)) *Cluster_Unreserve_Call {
	_c.Call.Run(func(args mock.Arguments) {
