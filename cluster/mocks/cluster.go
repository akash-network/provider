...
func (_m *Cluster) Reserve(_a0 v1beta3.OrderID, _a1 typesv1beta3.ResourceGroup) (clustertypesv1beta3.Reservation, error) {
	ret := _m.Called(_a0, _a1)

	var r0 clustertypesv1beta3.Reservation
	var r1 error
	if rf, ok := ret.Get(0).(func(v1beta3.OrderID, typesv1beta3.ResourceGroup) (clustertypesv1beta3.Reservation, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(v1beta3.OrderID, typesv1beta3.ResourceGroup) clustertypesv1beta3.Reservation); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(clustertypesv1beta3.Reservation)
		}
	}
...
func (_c *Cluster_Reserve_Call) Return(_a0 clustertypesv1beta3.Reservation, _a1 error) *Cluster_Reserve_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Cluster_Reserve_Call) RunAndReturn(run func(v1beta3.OrderID, typesv1beta3.ResourceGroup) (clustertypesv1beta3.Reservation, error)) *Cluster_Reserve_Call {
	_c.Call.Return(run)
	return _c
}
