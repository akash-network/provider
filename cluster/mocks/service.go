...
import (
	...
	nodetypesv1beta3 "github.com/akash-network/akash-api/go/node/types/v1beta3"
...
func (_m *Service) Reserve(_a0 v1beta3.OrderID, _a1 nodetypesv1beta3.ResourceGroup) (typesv1beta3.Reservation, error) {
	ret := _m.Called(_a0, _a1)

	var r0 typesv1beta3.Reservation
	var r1 error
	if rf, ok := ret.Get(0).(func(v1beta3.OrderID, nodetypesv1beta3.ResourceGroup) (typesv1beta3.Reservation, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(v1beta3.OrderID, nodetypesv1beta3.ResourceGroup) typesv1beta3.Reservation); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(v1beta3.OrderID, nodetypesv1beta3.ResourceGroup) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
//   - _a0 v1beta3.OrderID
//   - _a1 nodetypesv1beta3.ResourceGroup
...
func (_c *Service_Reserve_Call) Run(run func(_a0 v1beta3.OrderID, _a1 nodetypesv1beta3.ResourceGroup)) *Service_Reserve_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(v1beta3.OrderID), args[1].(nodetypesv1beta3.ResourceGroup))
	})
	return _c
}
...
func (_c *Service_Reserve_Call) RunAndReturn(run func(v1beta3.OrderID, nodetypesv1beta3.ResourceGroup) (typesv1beta3.Reservation, error)) *Service_Reserve_Call {
	_c.Call.Return(run)
	return _c
}
