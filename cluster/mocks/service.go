...
func (_m *Service) HostnameService() v1beta2.HostnameServiceClient {
	ret := _m.Called()
...
func (_c *Service_HostnameService_Call) Return(_a0 v1beta2.HostnameServiceClient) *Service_HostnameService_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Service_HostnameService_Call) RunAndReturn(run func() v1beta2.HostnameServiceClient) *Service_HostnameService_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Service) Reserve(_a0 v1beta3.OrderID, _a1 typesv1beta3.ResourceGroup) (v1beta2.Reservation, error) {
...
func (_c *Service_Reserve_Call) Run(run func(_a0 v1beta3.OrderID, _a1 typesv1beta3.ResourceGroup)) *Service_Reserve_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Service_Reserve_Call) Return(_a0 v1beta2.Reservation, _a1 error) *Service_Reserve_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Service_Reserve_Call) RunAndReturn(run func(v1beta3.OrderID, typesv1beta3.ResourceGroup) (v1beta2.Reservation, error)) *Service_Reserve_Call {
	_c.Call.Return(run)
	return _c
}

// Status provides a mock function with given fields: _a0
func (_m *Service) Status(_a0 context.Context) (*v1beta2.Status, error) {
	ret := _m.Called(_a0)

	var r0 *v1beta2.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*v1beta2.Status, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *v1beta2.Status); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta2.Status)
		}
	}
...
func (_c *Service_Status_Call) Return(_a0 *v1beta2.Status, _a1 error) *Service_Status_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Service_Status_Call) RunAndReturn(run func(context.Context) (*v1beta2.Status, error)) *Service_Status_Call {
	_c.Call.Return(run)
	return _c
}
