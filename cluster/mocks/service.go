...
// PortManager provides a mock function with no fields
func (_m *Service) PortManager() cluster.PortManager {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for PortManager")
	}

	var r0 cluster.PortManager
	if rf, ok := ret.Get(0).(func() cluster.PortManager); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(cluster.PortManager)
		}
	}
...
// Service_PortManager_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PortManager'
type Service_PortManager_Call struct {
	*mock.Call
}

// PortManager is a helper method to define mock.On call
func (_e *Service_Expecter) PortManager() *Service_PortManager_Call {
	return &Service_PortManager_Call{Call: _e.mock.On("PortManager")}
}

func (_c *Service_PortManager_Call) Run(run func()) *Service_PortManager_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Service_PortManager_Call) Return(_a0 cluster.PortManager) *Service_PortManager_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Service_PortManager_Call) RunAndReturn(run func() cluster.PortManager) *Service_PortManager_Call {
	_c.Call.Return(run)
	return _c
}
