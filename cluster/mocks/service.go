...
import (
	...
	typesv1beta2 "github.com/akash-network/provider/cluster/types/v1beta2"

	v1beta2 "github.com/akash-network/node/x/market/types/v1beta2"
...
func (_m *Service) Reserve(_a0 v1beta2.OrderID, _a1 nodetypesv1beta2.ResourceGroup) (typesv1beta2.Reservation, error) {
	ret := _m.Called(_a0, _a1)

	var r0 typesv1beta2.Reservation
	if rf, ok := ret.Get(0).(func(v1beta2.OrderID, nodetypesv1beta2.ResourceGroup) typesv1beta2.Reservation); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(v1beta2.OrderID, nodetypesv1beta2.ResourceGroup) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
