...
//   - ctx context.Context
//   - directive v1beta2.ClusterIPPassthroughDirective
...
func (_c *MetalLBClient_CreateIPPassthrough_Call) Run(run func(ctx context.Context, directive v1beta2.ClusterIPPassthroughDirective)) *MetalLBClient_CreateIPPassthrough_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(v1beta2.ClusterIPPassthroughDirective))
	})
	return _c
}
...
func (_c *MetalLBClient_CreateIPPassthrough_Call) RunAndReturn(run func(context.Context, v1beta2.ClusterIPPassthroughDirective) error) *MetalLBClient_CreateIPPassthrough_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MetalLBClient) GetIPAddressStatusForLease(ctx context.Context, leaseID v1beta3.LeaseID) ([]v1beta2.IPLeaseState, error) {
	ret := _m.Called(ctx, leaseID)

	var r0 []v1beta2.IPLeaseState
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, v1beta3.LeaseID) ([]v1beta2.IPLeaseState, error)); ok {
		return rf(ctx, leaseID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, v1beta3.LeaseID) []v1beta2.IPLeaseState); ok {
		r0 = rf(ctx, leaseID)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MetalLBClient_GetIPAddressStatusForLease_Call) Run(run func(ctx context.Context, leaseID v1beta3.LeaseID)) *MetalLBClient_GetIPAddressStatusForLease_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MetalLBClient_GetIPAddressStatusForLease_Call) Return(_a0 []v1beta2.IPLeaseState, _a1 error) *MetalLBClient_GetIPAddressStatusForLease_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetalLBClient_GetIPAddressStatusForLease_Call) RunAndReturn(run func(context.Context, v1beta3.LeaseID) ([]v1beta2.IPLeaseState, error)) *MetalLBClient_GetIPAddressStatusForLease_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MetalLBClient) GetIPPassthroughs(ctx context.Context) ([]v1beta2.IPPassthrough, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]v1beta2.IPPassthrough, error)); ok {
		return rf(ctx)
	}
...
func (_c *MetalLBClient_GetIPPassthroughs_Call) Return(_a0 []v1beta2.IPPassthrough, _a1 error) *MetalLBClient_GetIPPassthroughs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetalLBClient_GetIPPassthroughs_Call) RunAndReturn(run func(context.Context) ([]v1beta2.IPPassthrough, error)) *MetalLBClient_GetIPPassthroughs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MetalLBClient_PurgeIPPassthrough_Call) Run(run func(ctx context.Context, directive v1beta2.ClusterIPPassthroughDirective)) *MetalLBClient_PurgeIPPassthrough_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(v1beta2.ClusterIPPassthroughDirective))
	})
	return _c
...
func (_c *MetalLBClient_PurgeIPPassthrough_Call) RunAndReturn(run func(context.Context, v1beta2.ClusterIPPassthroughDirective) error) *MetalLBClient_PurgeIPPassthrough_Call {
	_c.Call.Return(run)
	return _c
}
