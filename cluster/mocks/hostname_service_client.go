...
func (_m *HostnameServiceClient) PrepareHostnamesForTransfer(ctx context.Context, hostnames []string, leaseID marketv1beta3.LeaseID) error {
	ret := _m.Called(ctx, hostnames, leaseID)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, marketv1beta3.LeaseID) error); ok {
...
func (_c *HostnameServiceClient_PrepareHostnamesForTransfer_Call) Run(run func(ctx context.Context, hostnames []string, leaseID marketv1beta3.LeaseID)) *HostnameServiceClient_PrepareHostnamesForTransfer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string), args[2].(marketv1beta3.LeaseID))
	})
	return _c
}
...
func (_m *HostnameServiceClient) ReleaseHostnames(leaseID marketv1beta3.LeaseID) error {
	ret := _m.Called(leaseID)

	var r0 error
	if rf, ok := ret.Get(0).(func(marketv1beta3.LeaseID) error); ok {
		r0 = rf(leaseID)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *HostnameServiceClient_ReleaseHostnames_Call) Run(run func(leaseID marketv1beta3.LeaseID)) *HostnameServiceClient_ReleaseHostnames_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(marketv1beta3.LeaseID))
	})
	return _c
}
...
func (_c *HostnameServiceClient_ReleaseHostnames_Call) RunAndReturn(run func(marketv1beta3.LeaseID) error) *HostnameServiceClient_ReleaseHostnames_Call {
	_c.Call.Return(run)
	return _c
}

// ReserveHostnames provides a mock function with given fields: ctx, hostnames, leaseID
func (_m *HostnameServiceClient) ReserveHostnames(ctx context.Context, hostnames []string, leaseID marketv1beta3.LeaseID) ([]string, error) {
	ret := _m.Called(ctx, hostnames, leaseID)

	var r0 []string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, marketv1beta3.LeaseID) ([]string, error)); ok {
		return rf(ctx, hostnames, leaseID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, marketv1beta3.LeaseID) []string); ok {
		r0 = rf(ctx, hostnames, leaseID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, marketv1beta3.LeaseID) error); ok {
...
func (_c *HostnameServiceClient_ReserveHostnames_Call) Run(run func(ctx context.Context, hostnames []string, leaseID marketv1beta3.LeaseID)) *HostnameServiceClient_ReserveHostnames_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string), args[2].(marketv1beta3.LeaseID))
	})
	return _c
...
func (_c *HostnameServiceClient_ReserveHostnames_Call) RunAndReturn(run func(context.Context, []string, marketv1beta3.LeaseID) ([]string, error)) *HostnameServiceClient_ReserveHostnames_Call {
	_c.Call.Return(run)
	return _c
}
