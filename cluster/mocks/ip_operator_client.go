...
func (_m *IPOperatorClient) GetIPAddressStatus(ctx context.Context, orderID v1beta4.OrderID) ([]types.LeaseIPStatus, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, v1beta4.OrderID) ([]types.LeaseIPStatus, error)); ok {
		return rf(ctx, orderID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, v1beta4.OrderID) []types.LeaseIPStatus); ok {
		r0 = rf(ctx, orderID)
	} else {
		if ret.Get(0) != nil {
...
func (_c *IPOperatorClient_GetIPAddressStatus_Call) Run(run func(ctx context.Context, orderID v1beta4.OrderID)) *IPOperatorClient_GetIPAddressStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IPOperatorClient_GetIPAddressStatus_Call) RunAndReturn(run func(context.Context, v1beta4.OrderID) ([]types.LeaseIPStatus, error)) *IPOperatorClient_GetIPAddressStatus_Call {
	_c.Call.Return(run)
	return _c
}
