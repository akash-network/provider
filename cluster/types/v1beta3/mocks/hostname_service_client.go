...
func (_m *HostnameServiceClient) PrepareHostnamesForTransfer(ctx context.Context, hostnames []string, leaseID v1beta4.LeaseID) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, v1beta4.LeaseID) error); ok {
...
func (_c *HostnameServiceClient_PrepareHostnamesForTransfer_Call) Run(run func(ctx context.Context, hostnames []string, leaseID v1beta4.LeaseID)) *HostnameServiceClient_PrepareHostnamesForTransfer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string), args[2].(v1beta4.LeaseID))
	})
	return _c
}
...
func (_m *HostnameServiceClient) ReleaseHostnames(leaseID v1beta4.LeaseID) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(v1beta4.LeaseID) error); ok {
		r0 = rf(leaseID)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *HostnameServiceClient) ReserveHostnames(ctx context.Context, hostnames []string, leaseID v1beta4.LeaseID) ([]string, error) {
	...
	var r0 []string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, v1beta4.LeaseID) ([]string, error)); ok {
		return rf(ctx, hostnames, leaseID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, v1beta4.LeaseID) []string); ok {
		r0 = rf(ctx, hostnames, leaseID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, v1beta4.LeaseID) error); ok {
