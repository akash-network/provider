...
type Client interface {
	...
	// either payload.
	//
	// When service is non-empty, the request targets a specific service's pods.
...
func (c *nullClient) AttestationQuote(_ context.Context, _ mtypes.LeaseID, _ string, _ uint, _ []byte) ([]byte, int, error) {
