...
func newCCStorageWorkload(t *testing.T, runtimeClass RuntimeClass, specs ...ccStorageSpec) *Workload {
	...
	return &Workload{
		builder: builder{
			...
			settings:   Settings{CCInitData: testCCInitDataSettings(t)},
...
func TestConfidentialPersistentStorageBuildsMeasuredBlockContract(t *testing.T) {
	...
	require.Equal(t, ccPersistentVolumeID("proof", "data", testSealedKeyRef), descriptor.Volumes[0].VolumeID)
}
...
func TestConfidentialInitDataMatchesCanaryContract(t *testing.T) {
	certificate, err := os.ReadFile("testdata/cc-initdata-kbs.pem")
	require.NoError(t, err)
	...
	require.Equal(
		t,
		"93c0e2ab639c4e6897fa257f8c3573075bb692b89e8851bdbc0e48158844b299",
		hex.EncodeToString(digest[:]),
		"digest is independently generated by the Python canary renderer",
	)
}
