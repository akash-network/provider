...
func interconnectResourcePair(capacity int64) inventoryV1.ResourcePair {
	return inventoryV1.NewResourcePair(capacity, capacity, 0, resource.DecimalSI)
}
