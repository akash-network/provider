...
require (
	...
	pkg.akt.dev/go v0.2.0-b15
	pkg.akt.dev/go/cli v0.2.0-b12
	pkg.akt.dev/go/sdl v0.2.0-b2
	pkg.akt.dev/node/v2 v2.0.0-rc3
...
require (
	...
	github.com/ianlancetaylor/cgosymbolizer v0.0.0-20250410214317-b8ecc8b6bbe6 // indirect
