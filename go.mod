...
require (
	...
	pkg.akt.dev/go v0.4.0-a6
	pkg.akt.dev/go/cli v0.4.0-a6
	pkg.akt.dev/go/sdl v0.4.0-a6
...
replace pkg.akt.dev/node/v3 => github.com/akash-network/node/v3 v3.0.0-a4
