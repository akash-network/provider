...
.PHONY: kube-install-helm-charts
kube-install-helm-charts: $(patsubst %, kube-install-helm-chart-%,$(HELM_CHARTS))
...
.PHONY: kube-install-helm-chart-loki
kube-install-helm-chart-loki:
