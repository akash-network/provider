...
import (
	v1 "github.com/ovrclk/provider-services/pkg/client/informers/externalversions/akash.network/v1"
	v2beta1 "github.com/ovrclk/provider-services/pkg/client/informers/externalversions/akash.network/v2beta1"
