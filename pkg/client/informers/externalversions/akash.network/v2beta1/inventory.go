...
type InventoryInformer interface {
	...
	Lister() akashnetworkv2beta1.InventoryLister
}
...
func NewFilteredInventoryInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&apisakashnetworkv2beta1.Inventory{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *inventoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisakashnetworkv2beta1.Inventory{}, f.defaultInformer)
}

func (f *inventoryInformer) Lister() akashnetworkv2beta1.InventoryLister {
	return akashnetworkv2beta1.NewInventoryLister(f.Informer().GetIndexer())
}
