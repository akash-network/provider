...
type InventoryStatusApplyConfiguration struct {
	State    *akashnetworkv2beta1.InventoryState `json:"state,omitempty"`
...
func (b *InventoryStatusApplyConfiguration) WithState(value akashnetworkv2beta1.InventoryState) *InventoryStatusApplyConfiguration {
	b.State = &value
	return b
}
