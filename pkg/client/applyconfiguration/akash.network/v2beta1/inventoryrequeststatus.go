...
// InventoryRequestStatusApplyConfiguration represents a declarative configuration of the InventoryRequestStatus type for use
// with apply.
...
// InventoryRequestStatusApplyConfiguration constructs a declarative configuration of the InventoryRequestStatus type for use with
// apply.
func InventoryRequestStatus() *InventoryRequestStatusApplyConfiguration {
	return &InventoryRequestStatusApplyConfiguration{}
}
