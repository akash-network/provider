...
type ProviderLeasedIPApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *ProviderLeasedIPStatusApplyConfiguration `json:"status,omitempty"`
}
...
func ProviderLeasedIP(name, namespace string) *ProviderLeasedIPApplyConfiguration {
	...
	b.WithAPIVersion("akash.network/v2beta1")
	return b
}
...
func (b *ProviderLeasedIPApplyConfiguration) WithStatus(value *ProviderLeasedIPStatusApplyConfiguration) *ProviderLeasedIPApplyConfiguration {
	b.Status = value
	return b
}
