...
type ProviderHostInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*v2beta2.ProviderHostList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta2.ProviderHost, err error)
...
func (c *providerHosts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2beta2.ProviderHost, err error) {
...
func (c *providerHosts) List(ctx context.Context, opts v1.ListOptions) (result *v2beta2.ProviderHostList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2beta2.ProviderHostList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("providerhosts").
...
func (c *providerHosts) Create(ctx context.Context, providerHost *v2beta2.ProviderHost, opts v1.CreateOptions) (result *v2beta2.ProviderHost, err error) {
	result = &v2beta2.ProviderHost{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("providerhosts").
...
func (c *providerHosts) Update(ctx context.Context, providerHost *v2beta2.ProviderHost, opts v1.UpdateOptions) (result *v2beta2.ProviderHost, err error) {
	result = &v2beta2.ProviderHost{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("providerhosts").
...
func (c *providerHosts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta2.ProviderHost, err error) {
	result = &v2beta2.ProviderHost{}
