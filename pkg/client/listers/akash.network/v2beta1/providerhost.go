...
type ProviderHostLister interface {
	...
	List(selector labels.Selector) (ret []*akashnetworkv2beta1.ProviderHost, err error)
...
type providerHostLister struct {
	listers.ResourceIndexer[*akashnetworkv2beta1.ProviderHost]
}
...
func NewProviderHostLister(indexer cache.Indexer) ProviderHostLister {
	return &providerHostLister{listers.New[*akashnetworkv2beta1.ProviderHost](indexer, akashnetworkv2beta1.Resource("providerhost"))}
}

// ProviderHosts returns an object that can list and get ProviderHosts.
func (s *providerHostLister) ProviderHosts(namespace string) ProviderHostNamespaceLister {
	return providerHostNamespaceLister{listers.NewNamespaced[*akashnetworkv2beta1.ProviderHost](s.ResourceIndexer, namespace)}
}
...
type ProviderHostNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*akashnetworkv2beta1.ProviderHost, error)
