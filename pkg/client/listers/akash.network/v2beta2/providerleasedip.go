...
type ProviderLeasedIPLister interface {
	...
	List(selector labels.Selector) (ret []*akashnetworkv2beta2.ProviderLeasedIP, err error)
...
type providerLeasedIPLister struct {
	listers.ResourceIndexer[*akashnetworkv2beta2.ProviderLeasedIP]
}
...
func NewProviderLeasedIPLister(indexer cache.Indexer) ProviderLeasedIPLister {
	return &providerLeasedIPLister{listers.New[*akashnetworkv2beta2.ProviderLeasedIP](indexer, akashnetworkv2beta2.Resource("providerleasedip"))}
}

// ProviderLeasedIPs returns an object that can list and get ProviderLeasedIPs.
func (s *providerLeasedIPLister) ProviderLeasedIPs(namespace string) ProviderLeasedIPNamespaceLister {
	return providerLeasedIPNamespaceLister{listers.NewNamespaced[*akashnetworkv2beta2.ProviderLeasedIP](s.ResourceIndexer, namespace)}
}
...
type ProviderLeasedIPNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*akashnetworkv2beta2.ProviderLeasedIP, error)
