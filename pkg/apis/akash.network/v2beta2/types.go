...
func NewManifest(ns string, lid mtypes.LeaseID, mgroup *maniv2beta2.Group) (*Manifest, error) {
...
func (m *ManifestGroup) toAkash() (maniv2beta2.Group, error) {
	am := maniv2beta2.Group{
		Name:     m.Name,
		Services: make([]maniv2beta2.Service, 0, len(m.Services)),
	}
...
func manifestGroupFromAkash(m *maniv2beta2.Group) (ManifestGroup, error) {
	ma := ManifestGroup{
		Name:     m.Name,
...
func (ms *ManifestService) toAkash() (maniv2beta2.Service, error) {
	res, err := ms.Resources.toAkash()
	if err != nil {
		return maniv2beta2.Service{}, err
	}

	ams := &maniv2beta2.Service{
		Name:      ms.Name,
		Image:     ms.Image,
		Command:   ms.Command,
		Args:      ms.Args,
		...
		Resources: res,
		Count:     ms.Count,
		Expose:    make([]maniv2beta2.ServiceExpose, 0, len(ms.Expose)),
	}
	...
	if ms.Params != nil {
		ams.Params = &maniv2beta2.ServiceParams{
			Storage: make([]maniv2beta2.StorageParams, 0, len(ms.Params.Storage)),
		}

		for _, storage := range ms.Params.Storage {
			ams.Params.Storage = append(ams.Params.Storage, maniv2beta2.StorageParams{
				Name:     storage.Name,
				Mount:    storage.Mount,
...
func manifestServiceFromAkash(ams maniv2beta2.Service) (ManifestService, error) {
...
func (mse ManifestServiceExpose) toAkash() (maniv2beta2.ServiceExpose, error) {
	proto, err := maniv2beta2.ParseServiceProtocol(mse.Proto)
	if err != nil {
		return maniv2beta2.ServiceExpose{}, err
	}
	return maniv2beta2.ServiceExpose{
		...
		IP:                     mse.IP,
		HTTPOptions: maniv2beta2.ServiceExposeHTTPOptions{
...
func manifestServiceExposeFromAkash(amse maniv2beta2.ServiceExpose) ManifestServiceExpose {
